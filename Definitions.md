...
**AST** stands for _abstract syntax tree_, is an ordered tree whose leaves are variables, and whose interior nodes are operators whose arguments are its children. 
